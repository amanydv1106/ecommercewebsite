...
export const dummyRatingsData = [
    { id: "rat_1", rating: 4.2, review: "I was a bit skeptical at first, but this product turned out to be even better than I imagined. The quality feels premium, it's easy to use, and it delivers exactly what was promised. I've already recommended it to friends and will definitely purchase again in the future.", user: { name: 'Priya Sharma', image: profile_pic1 }, productId: "prod_1", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_2", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Rohit Verma', image: profile_pic2 }, productId: "prod_2", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_3", rating: 4.1, review: "This product is amazing. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Aditi Nair', image: profile_pic3 }, productId: "prod_3", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_4", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Priya Sharma', image: profile_pic1 }, productId: "prod_4", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_5", rating: 4.3, review: "Overall, I'm very happy with this purchase. It works as described and feels durable. The only reason I didn't give it five stars is because of a small issue (such as setup taking a bit longer than expected, or packaging being slightly damaged). Still, highly recommend it for anyone looking for a reliable option.", user: { name: 'Rohit Verma', image: profile_pic2 }, productId: "prod_5", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_6", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Aditi Nair', image: profile_pic3 }, productId: "prod_6", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
]
...
export const dummyStoreData = {
    ...
    username: "happyshop",
    address: "3rd Floor, Happy Shop, New Building, 11 MG Road, Connaught Place, New Delhi, India",
    status: "approved",
    isActive: true,
    logo: happy_store,
    ...
    user: {
        ...
        name: "Super Stack",
        email: "user.superstack@gmail.com",
        image: gs_logo,
    }
}
...
export const couponDummyData = [
    ...
    { code: "OFF10", description: "10% Off for All Users", discount: 10, forNewUser: false, forMember: false, isPublic: false, expiresAt: "2026-12-31T00:00:00.000Z", createdAt: "2025-08-22T08:42:08.218Z" },
]
...
export const orderDummyData = [
    {
        ...
        isPaid: false,
        paymentMethod: "COD",
        createdAt: "2025-08-22T14:45:03.929+05:30",
        updatedAt: "2025-08-22T14:45:50.723+05:30",
        isCouponUsed: true,
        coupon: dummyRatingsData[2],
        orderItems: [
            { orderId: "cmemm75h5001jtat89016h1p3", productId: "cmemlydnx0017tat8h3rg92hz", quantity: 1, price: 890, product: productDummyData[0] },
            { orderId: "cmemm75h5001jtat89016h1p3", productId: "cmemlxgnk0015tat84qm8si5v", quantity: 1, price: 1490, product: productDummyData[1] }
        ],
        address: {
            ...addressDummyData,
            name: "Rahul Mehta",
    ...
    },
    {
        ...
        isPaid: false,
        paymentMethod: "COD",
        createdAt: "2025-08-22T14:44:35.923+05:30",
        updatedAt: "2025-08-22T14:45:52.535+05:30",
        isCouponUsed: true,
        coupon: couponDummyData[0],
        orderItems: [
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemm1f3y001dtat8liccisar", quantity: 1, price: 2290, product: productDummyData[2] },
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemm0nh2001btat8glfvhry1", quantity: 1, price: 990, product: productDummyData[3] },
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemlz8640019tat8kz7emqca", quantity: 1, price: 1990, product: productDummyData[4] }
        ],
        address: {
            ...addressDummyData,
            name: "Neha Sharma",
            street: "12 Green Park Road",
            city: "Pune",
            state: "Maharashtra",
            zip: "411001",
            country: "India",
...
export const storesDummyData = [
    {
        ...
        username: "greatstack",
        address: "12 Green Park Road, Sector 5, Pune, Maharashtra, India",
        status: "approved",
        isActive: true,
        logo: gs_logo,
        email: "greatstack@gmail.com",
...
export const dummyAdminDashboardData = {
    ...
    revenue: "959.10",
    allOrders: [
        { createdAt: "2025-08-20T08:46:58.239Z", total: 1456.50 },
        { createdAt: "2025-08-22T08:46:21.818Z", total: 972.00 },
        { createdAt: "2025-08-22T08:45:59.587Z", total: 544.00 },
        { createdAt: "2025-08-23T09:15:03.929Z", total: 2142.00 },
        { createdAt: "2025-08-23T09:14:35.923Z", total: 4216.00 },
        { createdAt: "2025-08-23T11:44:29.713Z", total: 261.00 },
        { createdAt: "2025-08-24T09:15:03.929Z", total: 2142.00 },
        { createdAt: "2025-08-24T09:14:35.923Z", total: 4216.00 },
        { createdAt: "2025-08-24T11:44:29.713Z", total: 261.00 },
        { createdAt: "2025-08-24T11:56:29.713Z", total: 361.00 },
        { createdAt: "2025-08-25T11:44:29.713Z", total: 261.00 },
        { createdAt: "2025-08-25T09:15:03.929Z", total: 2142.00 },
        { createdAt: "2025-08-25T09:14:35.923Z", total: 4216.00 },
        { createdAt: "2025-08-25T11:44:29.713Z", total: 261.00 },
        { createdAt: "2025-08-25T11:56:29.713Z", total: 361.00 },
        { createdAt: "2025-08-25T11:30:29.713Z", total: 1101.00 }
    ]
}

export const dummyStoreDashboardData = {
    ratings: dummyRatingsData.map(r => ({
        ...r,
        user: {
            name: r.user.name.replace(/.*/, name => {
                const indianNames = ["Anjali Gupta", "Vikram Singh", "Neha Sharma", "Rohit Mehta", "Priya Nair", "Amit Joshi"];
